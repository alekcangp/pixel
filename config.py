...
PREWARM_CHUNK_SIZE = 100

# ============================================================
# Кэш метаданных файлов для галереи (mtime/size)
# ============================================================
# os.stat на macOS может внезапно блокироваться на секунды (Spotlight,
# iCloud Drive, сброс кэша inode). mtime/size нужны только для проверки
# актуальности миниатюр в БД; TTL-кэш убирает повторные stat одних и тех же
# файлов при листании страниц. Устаревшая запись максимум TTL секунд означает
# лишь возможную лишнюю перегенерацию миниатюры позже.
META_CACHE_TTL = 300
